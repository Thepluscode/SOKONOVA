...
export type NotificationType = 'ORDER_PAID' | 'ORDER_SHIPPED' | 'ORDER_OUT_FOR_DELIVERY' | 'ORDER_DELIVERED' | 'DISPUTE_OPENED' | 'DISPUTE_RESOLVED' | 'PAYOUT_RELEASED' | 'RISK_ALERT' | 'NEW_REVIEW' | 'EXCEPTION_ALERT' | 'SELLER_EXCEPTION' | 'MICRO_FULFILLMENT_OPT_IN';
